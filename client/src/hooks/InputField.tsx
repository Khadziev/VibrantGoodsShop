...
export const fields = [
  ...
  { id: 'imageURL0', type: 'text', name: 'imageURL0', label: 'URL изображения 1', required: false },
  { id: 'imageURL1', type: 'text', name: 'imageURL1', label: 'URL изображения 2', required: false },
  { id: 'imageURL2', type: 'text', name: 'imageURL2', label: 'URL изображения 3', required: false },
