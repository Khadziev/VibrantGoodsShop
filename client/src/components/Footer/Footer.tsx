        ...
        <div className="m-auto md:w-10/12 lg:w-8/12 xl:w-6/12">
          <div className="flex flex-wrap items-center justify-between md:flex-nowrap">
            ...
            <div className="w-10/12 m-auto  mt-16 space-y-6 text-center sm:text-left sm:w-5/12 sm:mt-auto">
              <span className="block text-gray-300">Мы меняем способ использования библиотек компонентов пользовательского интерфейса</span>
              <span className="block text-gray-300">Tailus Blocks &copy; 2023</span>
              ...
              <span className="block text-gray-300">Нужна помощь? <Link to="/#" className="font-semibold text-white"> Свяжитесь с нами</Link></span>
            </div>
          </div>
        </div>
      </div>
