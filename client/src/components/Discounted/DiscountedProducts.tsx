...
import discount from "../../assets/discount-icon/discount.webp";
      ...
      <div className="flex items-center justify-center">
        ...
        <div className="overflow-hidden flex space-x-2 items-center justify-center flex-grow">
          {currentProducts.map((product) => (
            <div
              key={product._id}
              className="flex-none border border-white rounded px-2 bg-gray-800 text-white text-center w-52 h-80"
            >
